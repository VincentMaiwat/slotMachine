...
(async () =>
{
    ...
    //Add Pikachu
    const texturePikachu = await Assets.load('images/assets/pikachu.png');
    const spritePikachu = Sprite.from(texturePikachu);
    app.stage.addChild(spritePikachu);

    spritePikachu.scale.set(.5,.2);
    ...
    const playText = new Text('Choose your Pokemon!', style);
